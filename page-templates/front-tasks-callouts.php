 ...
 * The template for displaying a featured home page widget
 * as a callout below the intro content area
...
<?php
		// Display Homepage Featured Widget.
...
<div class="main-container">
	...
	<?php else : ?>
		<div class="main-grid homepage">
			<main class="main-content-full-width homepage-news">
	<?php endif; ?>
			<?php
			// News Query.
