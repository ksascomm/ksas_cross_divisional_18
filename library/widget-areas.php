	...
	function ksasacademic_sidebar_widgets() {
		...
		register_sidebar(
			array(
				...
				'name'          => __( 'Homepage Featured', 'ksasacademic' ),
				'description'   => __( 'The featured widget for the homepage only. Appears on specific Front (Tasks & Callouts) template.', 'ksasacademic' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s callout home-featured-widget" aria-label="Homepage Content %1$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widgettitle">',
				'after_title'   => '</h3>',
			)
		...
		register_sidebar(
			array(
				...
				'description'   => __( 'The sidebar for the homepage only. Appears next to News/Hub and below Global Sidebar', 'ksasacademic' ),
